...
<c:set var="boardTargetGame" value="${safeGameId == 'all' ? 'lol' : safeGameId}" />
...
<div class="side-card">
    ...
    <div class="menu-item-group">
        ...
        <div class="sub-menu-container">
            ...
            <a href="<c:url value='/board/free_${boardTargetGame}' />">
                <div class="sub-item">자유게시판</div>
            </a>
            <%-- 공략게시판 (언더바 방식) --%>
            <a href="<c:url value='/board/strategy_${boardTargetGame}' />">
