...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/board/free_write/style.css">
	<script src="${pageContext.request.contextPath}/resources/board/free_write/script.js"></script>
	
    <title>LOG.GG - 자유게시판 글쓰기</title>
</head>
<body>
        ...
        <main class="content-area">
            ...
            <div class="write-container">
                <div class="category-fixed-bar">
                    ...
                    <span class="category-text" id="targetGame">배틀그라운드 > 자유 게시판</span>
                </div>
